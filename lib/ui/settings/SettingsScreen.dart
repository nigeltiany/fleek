                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                        ...
                        trailing: GestureDetector(
                          ...
                          child: Text(
                              !user.settings.distanceRadius.isNaN
                                  ? '$radius '
                                  'Miles'
                                  : 'Unlimited',
                              style: TextStyle(
                      ...
                      ListTile(
                        ...
                        trailing: GestureDetector(
                          ...
                          child: Text('${gender.toFirebaseString()}',
                              style: TextStyle(
                                  fontSize: 17,
                                  color: isDarkMode(context)
                                      ? Colors.white : Colors.black,
                      ...
                      ListTile(
                        ...
                        trailing: GestureDetector(
                          ...
                          child: Text('${prefGender.toFirebaseString()}',
                              style: TextStyle(
                                  fontSize: 17,
                                  color: isDarkMode(context)
                                      ? Colors.white : Colors.black,
                    ...
                    child: Material(
                      ...
                      child: CupertinoButton(
                        ...
                        onPressed: () async {
                          ...
                          AppUser updateUser = await FireStoreUtils.updateCurrentUser(user);
    ...
    final action = CupertinoActionSheet(
      ...
      actions: <Widget>[
        CupertinoActionSheetAction(
          ...
          onPressed: () {
            Navigator.pop(context);
            prefGender = GenderPreference.FEMALE;
            setState(() {});
          },
        ),
        CupertinoActionSheetAction(
          ...
          onPressed: () {
            Navigator.pop(context);
            prefGender = GenderPreference.MALE;
            setState(() {});
          },
        ),
        CupertinoActionSheetAction(
          ...
          onPressed: () {
            Navigator.pop(context);
            prefGender = GenderPreference.ALL;
            setState(() {});
          },
        )
      ],
